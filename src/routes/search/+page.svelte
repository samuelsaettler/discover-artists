...
<div class="container-fluid bg-black text-white py-4">
  <div class="container mb-4">
    <form class="d-flex" method="GET">
      <input type="text" name="q" class="form-control me-2" placeholder="Daft Punk, The Weekend, etc." required/>
      ...
      <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 g-4">
        {#each data.results as artist}
          <div class="col">
            ...
            <a href={`/artist/${artist.id}`} rel="external" class="text-decoration-none">
              <ArtistCard
                name={artist.name}
                image={artist.image}
              />
